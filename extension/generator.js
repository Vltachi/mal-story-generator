...
const state = { title:'', eps:'', score:9, cover:null, avatar:null, mal:null, status:'completed' };

// Carrega logo MAL embutido automaticamente
(function() {
  const img = new Image();
  img.onload = () => { state.mal = img; render(); };
  img.src = MAL_LOGO_DATA_URL;
})();
...
function drawCard(canvas) {
  ...
  const ls=18*sc, wTxt='MyAnimeList';
